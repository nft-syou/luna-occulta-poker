...
**[yoiyami.syou.io](https://yoiyami.syou.io/) で遊べます。** **遊ぶのに準備は要りません** — キーもアカウントも不要で、サイトを開いて座るだけです。自分で運営する場合は [Cloudflare Workers へデプロイ](#cloudflare-workers-へデプロイ) を参照してください。
